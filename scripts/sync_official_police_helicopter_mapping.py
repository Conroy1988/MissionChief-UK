...
POLICE_HELICOPTER_MAPPING = {
    "status": "verified",
    "canonical_target": "requirements.guaranteed",
    "canonical_id": "police_helicopter",
    "checked_at": "2026-07-23",
    "sources": [
        "https://www.missionchief.co.uk/einsaetze/91",
        "https://www.missionchief.co.uk/einsaetze/206",
        "https://www.missionchief.co.uk/einsaetze/300",
        "https://www.missionchief.co.uk/einsaetze.json",
    ],
    "notes": "The official police_helicopters count is the guaranteed number of Police Helicopters.",
}

POLICE_HELICOPTER_STATION_MAPPING = {
    "status": "verified",
    "canonical_target": "preconditions",
    "canonical_id": "police_helicopter_stations",
    "checked_at": "2026-07-23",
    "sources": [
        "https://www.missionchief.co.uk/einsaetze/91",
        "https://www.missionchief.co.uk/einsaetze/206",
    ...
    "notes": "The official police_helicopter_stations value is the minimum Police Helicopter Station count used to generate the mission.",
}
...
def synchronized_document() -> dict[str, Any]:
    ...
    output_requirements["police_helicopters"] = POLICE_HELICOPTER_MAPPING
    output_prerequisites["police_helicopter_stations"] = POLICE_HELICOPTER_STATION_MAPPING
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Synchronize Police Helicopter requirement and station mappings")
    ...
    try:
        ...
        print(f"Police Helicopter mapping synchronization failed: {exc}", file=sys.stderr)
        return 1

    changed = current != content
    if args.check and changed:
        print("Police Helicopter mapping synchronization check failed: registry is stale", file=sys.stderr)
        return 1
    if changed and not args.check:
        MAPPING_PATH.write_text(content, encoding="utf-8")
    print(
        "Police Helicopter mapping "
