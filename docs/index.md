...
<div class="mcuk-hero-telemetry">
  ...
  <div><strong data-mcuk-metric="missions">240</strong><span>Canonical mapped</span></div>
  <div><strong>182</strong><span>Fully canonical</span></div>
</div>
...
<a class="mcuk-command-card mcuk-command-card--blue" href="tools/mission-lookup/">
  ...
  <p>Search 1,062 official UK missions alongside 240 higher-trust canonical mappings, with every published field retained.</p>
  <em>Launch lookup →</em>
</a>
...
<div class="mcuk-operations-board">
  ...
  <div class="mcuk-board-metrics">
    <div><strong data-mcuk-collection="missions">240</strong><span>Canonical missions</span><i>Mapped requirements, outcomes and generation</i></div>
  ...
  <div class="mcuk-board-footer">
    ...
    <span><b>223</b> direct ID matches</span>
    <span><b data-mcuk-search-count>316</b> canonical search entities</span>
