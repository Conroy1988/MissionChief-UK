...
<div class="mcuk-hero-telemetry">
  ...
  <div><strong data-mcuk-metric="missions">167</strong><span>Canonical mapped</span></div>
  <div><strong>109</strong><span>Fully canonical</span></div>
</div>
...
<a class="mcuk-command-card mcuk-command-card--blue" href="tools/mission-lookup/">
  ...
  <p>Search 1,062 official UK missions alongside 167 higher-trust canonical mappings, with every published field retained.</p>
  <em>Launch lookup →</em>
</a>
...
<div class="mcuk-operations-board">
  ...
  <div class="mcuk-board-metrics">
    <div><strong data-mcuk-collection="missions">167</strong><span>Canonical missions</span><i>Mapped requirements, outcomes and generation</i></div>
  ...
  <div class="mcuk-board-footer">
    ...
    <span><b>150</b> direct ID matches</span>
    <span><b data-mcuk-search-count>242</b> canonical search entities</span>
