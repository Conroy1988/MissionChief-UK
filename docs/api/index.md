...
Canonical missions: 133
Official UK missions: 1,062
Direct official/canonical ID matches: 116
Fully canonical missions: 75
```
...
```json
{
  ...
  "summary": {
    "official_count": 1062,
    "canonical_count": 133,
    "direct_canonical_id_matches": 116,
    "fully_canonical_percent": 7.06,
    "remaining_to_fully_canonical": 987
  },
  "records": []
}
```
