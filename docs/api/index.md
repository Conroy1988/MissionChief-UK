...
Canonical missions: 236
Official UK missions: 1,062
Direct official/canonical ID matches: 219
Fully canonical missions: 178
```
...
```json
{
  ...
  "summary": {
    "official_count": 1062,
    "canonical_count": 236,
    "direct_canonical_id_matches": 219,
    "fully_canonical_percent": 16.76,
    "remaining_to_fully_canonical": 884
  },
  "records": []
}
```
