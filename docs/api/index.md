...
Canonical missions: 168
Official UK missions: 1,062
Direct official/canonical ID matches: 151
Fully canonical missions: 110
```
...
```json
{
  ...
  "summary": {
    "official_count": 1062,
    "canonical_count": 168,
    "direct_canonical_id_matches": 151,
    "fully_canonical_percent": 10.36,
    "remaining_to_fully_canonical": 952
  },
  "records": []
}
```
