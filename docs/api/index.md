...
Canonical missions: 167
Official UK missions: 1,062
Direct official/canonical ID matches: 150
Fully canonical missions: 109
```
...
```json
{
  ...
  "summary": {
    "official_count": 1062,
    "canonical_count": 167,
    "direct_canonical_id_matches": 150,
    "fully_canonical_percent": 10.26,
    "remaining_to_fully_canonical": 953
  },
  "records": []
}
```
