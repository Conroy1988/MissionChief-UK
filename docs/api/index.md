...
Canonical missions: 250
Official UK missions: 1,062
Direct official/canonical ID matches: 233
Fully canonical missions: 192
```
...
```json
{
  ...
  "summary": {
    "official_count": 1062,
    "canonical_count": 250,
    "direct_canonical_id_matches": 233,
    "fully_canonical_percent": 18.08,
    "remaining_to_fully_canonical": 870
  },
  "records": []
}
```
