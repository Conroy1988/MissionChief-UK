...
Canonical missions: 277
Official UK missions: 1,062
Direct official/canonical ID matches: 260
Fully canonical missions: 219
```
...
```json
{
  ...
  "summary": {
    "official_count": 1062,
    "canonical_count": 277,
    "direct_canonical_id_matches": 260,
    "fully_canonical_percent": 20.62,
    "remaining_to_fully_canonical": 843
  },
  "records": []
}
```
