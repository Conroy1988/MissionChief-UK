...
Canonical missions: 253
Official UK missions: 1,062
Direct official/canonical ID matches: 236
Fully canonical missions: 195
```
...
```json
{
  ...
  "summary": {
    "official_count": 1062,
    "canonical_count": 253,
    "direct_canonical_id_matches": 236,
    "fully_canonical_percent": 18.36,
    "remaining_to_fully_canonical": 867
  },
  "records": []
}
```
