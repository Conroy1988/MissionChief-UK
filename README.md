...
[![Static API v1.0.0](https://img.shields.io/badge/STATIC_API-v1.0.0-0B1D31?style=for-the-badge&logo=json&logoColor=white)](https://conroy1988.github.io/MissionChief-UK/api/)
...
It combines human-readable guidance, canonical structured records, browser-side command tools, strict evidence rules and the versioned **Static API v1.0.0**, published as the **Static Data API v1.0.0**. The result is a single place to answer the questions that matter during real play:
