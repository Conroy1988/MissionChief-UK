...
**1,062 official UK missions · 243 canonical mission records · 185 fully canonical missions · Instant command search · Fleet planning · Evidence governance · Versioned public data**
...
| **Canonical missions** | **243** | Normalized higher-trust records |
| **Official/canonical ID matches** | **226** | Direct exact-ID evidence links |
| **Fully canonical missions** | **185** | Passed identity, mapping, operational and final evidence gates |
| **Official records awaiting canonical records** | **836** | Published records whose remaining semantics stay unguessed |
...
| **Canonical searchable entities** | **320** | Missions, resources, infrastructure and qualifications |
...
| Identity verified | **226 / 1,062 — 21.28%** |
| Fully canonical | **185 / 1,062 — 17.42%** |
...
Batches 4–20 extend the verified vehicle-key contract through evidence-safe, exact-ID promotions. All 185 records pass aggregate identity and strict-equivalence validation.
...
|---|---|---|
| **Canonical mapped** | 243 normalized project records | Verified resources, alternatives, probabilities, patients, personnel and preconditions where supported |
...
```text
data/uk/
├── missions/                       243 canonical mission records
