...
**1,062 official UK missions · 168 canonical mission records · 110 fully canonical missions · Instant command search · Fleet planning · Evidence governance · Versioned public data**
...
| **Canonical missions** | **168** | Normalized higher-trust records |
| **Official/canonical ID matches** | **151** | Direct exact-ID evidence links |
| **Fully canonical missions** | **110** | Passed identity, mapping, operational and final evidence gates |
| **Official records awaiting canonical records** | **911** | Published records whose remaining semantics stay unguessed |
...
| **Canonical searchable entities** | **243** | Missions, resources, infrastructure and qualifications |
...
| Identity verified | **151 / 1,062 — 14.22%** |
| Fully canonical | **110 / 1,062 — 10.36%** |
| Remaining to fully canonical | **952** |
...
Batches 4–14 extend the verified vehicle-key contract through evidence-safe, exact-ID promotions. All 110 records pass aggregate identity and strict-equivalence validation.
...
|---|---|---|
| **Canonical mapped** | 168 normalized project records | Verified resources, alternatives, probabilities, patients, personnel and preconditions where supported |
...
```text
data/uk/
├── missions/                       168 canonical mission records
