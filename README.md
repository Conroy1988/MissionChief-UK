...
**1,062 official UK missions · 240 canonical mission records · 182 fully canonical missions · Instant command search · Fleet planning · Evidence governance · Versioned public data**
...
| **Canonical missions** | **240** | Normalized higher-trust records |
| **Official/canonical ID matches** | **223** | Direct exact-ID evidence links |
| **Fully canonical missions** | **182** | Passed identity, mapping, operational and final evidence gates |
| **Official records awaiting canonical records** | **839** | Published records whose remaining semantics stay unguessed |
...
| **Canonical searchable entities** | **316** | Missions, resources, infrastructure and qualifications |
...
| Identity verified | **223 / 1,062 — 21.00%** |
| Fully canonical | **182 / 1,062 — 17.14%** |
...
Batches 4–19 extend the verified vehicle-key contract through evidence-safe, exact-ID promotions. All 182 records pass aggregate identity and strict-equivalence validation.
...
|---|---|---|
| **Canonical mapped** | 240 normalized project records | Verified resources, alternatives, probabilities, patients, personnel and preconditions where supported |
...
```text
data/uk/
├── missions/                       240 canonical mission records
