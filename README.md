...
**1,062 official UK missions · 169 canonical mission records · 111 fully canonical missions · Instant command search · Fleet planning · Evidence governance · Versioned public data**
...
| **Canonical missions** | **169** | Normalized higher-trust records |
| **Official/canonical ID matches** | **152** | Direct exact-ID evidence links |
| **Fully canonical missions** | **111** | Passed identity, mapping, operational and final evidence gates |
| **Official records awaiting canonical records** | **910** | Published records whose remaining semantics stay unguessed |
...
| **Canonical searchable entities** | **244** | Missions, resources, infrastructure and qualifications |
...
| Identity verified | **152 / 1,062 — 14.31%** |
| Fully canonical | **111 / 1,062 — 10.45%** |
| Remaining to fully canonical | **951** |
...
Batches 4–15 extend the verified vehicle-key contract through evidence-safe, exact-ID promotions. All 111 records pass aggregate identity and strict-equivalence validation.
...
|---|---|---|
| **Canonical mapped** | 169 normalized project records | Verified resources, alternatives, probabilities, patients, personnel and preconditions where supported |
...
```text
data/uk/
├── missions/                       169 canonical mission records
