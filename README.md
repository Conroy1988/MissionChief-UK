...
**1,062 official UK missions · 167 canonical mission records · 109 fully canonical missions · Instant command search · Fleet planning · Evidence governance · Versioned public data**
...
| **Canonical missions** | **167** | Normalized higher-trust records |
| **Official/canonical ID matches** | **150** | Direct exact-ID evidence links |
| **Fully canonical missions** | **109** | Passed identity, mapping, operational and final evidence gates |
| **Official records awaiting canonical records** | **912** | Published records whose remaining semantics stay unguessed |
...
| **Canonical searchable entities** | **242** | Missions, resources, infrastructure and qualifications |
...
| Identity verified | **150 / 1,062 — 14.12%** |
| Fully canonical | **109 / 1,062 — 10.26%** |
| Remaining to fully canonical | **953** |
...
Batches 4–13 extend the verified vehicle-key contract through evidence-safe, exact-ID promotions. All 109 records pass aggregate identity and strict-equivalence validation.
...
|---|---|---|
| **Canonical mapped** | 167 normalized project records | Verified resources, alternatives, probabilities, patients, personnel and preconditions where supported |
...
```text
data/uk/
├── missions/                       167 canonical mission records
