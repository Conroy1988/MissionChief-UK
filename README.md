...
**1,062 official UK missions · 155 canonical mission records · 97 fully canonical missions · Instant command search · Fleet planning · Evidence governance · Versioned public data**
...
| **Canonical missions** | **155** | Normalized higher-trust records |
| **Official/canonical ID matches** | **138** | Direct exact-ID evidence links |
| **Fully canonical missions** | **97** | Passed identity, mapping, operational and final evidence gates |
| **Official records awaiting canonical records** | **924** | Published records whose remaining semantics stay unguessed |
...
| **Canonical searchable entities** | **230** | Missions, resources, infrastructure and qualifications |
...
| Identity verified | **138 / 1,062 — 12.99%** |
| Fully canonical | **97 / 1,062 — 9.13%** |
| Remaining to fully canonical | **965** |
...
Batches 4–12 extend the verified vehicle-key contract through evidence-safe, exact-ID promotions. All 97 records pass aggregate identity and strict-equivalence validation.
...
|---|---|---|
| **Canonical mapped** | 155 normalized project records | Verified resources, alternatives, probabilities, patients, personnel and preconditions where supported |
...
```text
data/uk/
├── missions/                       155 canonical mission records
