...
**1,062 official UK missions · 151 canonical mission records · 93 fully canonical missions · Instant command search · Fleet planning · Evidence governance · Versioned public data**
...
| **Canonical missions** | **151** | Normalized higher-trust records |
| **Official/canonical ID matches** | **134** | Direct exact-ID evidence links |
| **Fully canonical missions** | **93** | Passed identity, mapping, operational and final evidence gates |
| **Official records awaiting canonical records** | **928** | Published records whose remaining semantics stay unguessed |
...
| **Canonical searchable entities** | **226** | Missions, resources, infrastructure and qualifications |
...
| Identity verified | **134 / 1,062 — 12.62%** |
| Fully canonical | **93 / 1,062 — 8.76%** |
| Remaining to fully canonical | **969** |
...
Batches 4–9 extend the verified vehicle-key contract through evidence-safe, exact-ID promotions. All 93 records pass aggregate identity and strict-equivalence validation.
...
|---|---|---|
| **Canonical mapped** | 151 normalized project records | Verified resources, alternatives, probabilities, patients, personnel and preconditions where supported |
...
```text
data/uk/
├── missions/                       151 canonical mission records
