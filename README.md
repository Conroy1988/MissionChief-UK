...
**1,062 official UK missions · 246 canonical mission records · 188 fully canonical missions · Instant command search · Fleet planning · Evidence governance · Versioned public data**
...
| **Canonical missions** | **246** | Normalized higher-trust records |
| **Official/canonical ID matches** | **229** | Direct exact-ID evidence links |
| **Fully canonical missions** | **188** | Passed identity, mapping, operational and final evidence gates |
| **Official records awaiting canonical records** | **833** | Published records whose remaining semantics stay unguessed |
...
| Identity verified | **229 / 1,062 — 21.56%** |
| Fully canonical | **188 / 1,062 — 17.70%** |
...
Batches 4–21 extend the verified vehicle-key contract through evidence-safe, exact-ID promotions. All 188 records pass aggregate identity and strict-equivalence validation.
...
|---|---|---|
| **Canonical mapped** | 246 normalized project records | Verified resources, alternatives, probabilities, patients, personnel and preconditions where supported |
...
```text
data/uk/
├── missions/                       246 canonical mission records
