...
**1,062 official UK missions · 142 canonical mission records · 84 fully canonical missions · Instant command search · Fleet planning · Evidence governance · Versioned public data**
...
| **Canonical missions** | **142** | Normalized higher-trust records |
| **Official/canonical ID matches** | **125** | Direct exact-ID evidence links |
| **Fully canonical missions** | **84** | Passed identity, mapping, operational and final evidence gates |
| **Official records awaiting canonical records** | **937** | Published records whose remaining semantics stay unguessed |
...
| **Canonical searchable entities** | **217** | Missions, resources, infrastructure and qualifications |
...
| Identity verified | **125 / 1,062 — 11.77%** |
| Fully canonical | **84 / 1,062 — 7.91%** |
| Remaining to fully canonical | **978** |
...
Batches 4–7 extend the verified vehicle-key contract through evidence-safe, exact-ID promotions. All 84 records pass aggregate identity and strict-equivalence validation.
...
|---|---|---|
| **Canonical mapped** | 142 normalized project records | Verified resources, alternatives, probabilities, patients, personnel and preconditions where supported |
...
```text
data/uk/
├── missions/                       142 canonical mission records
